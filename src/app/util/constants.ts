...
export class Constants {
    ...
    public static get DASHBOARD_API_HOST(): string {
        ...
        if(process.env.BUILD_TYPE == 'development') url = "http://localhost:3000/dashboard/api/v1/redis-cli/";// url = "http://terrabrasilis.dpi.inpe.br/homologation/dashboard/api/v1/redis-cli/";
